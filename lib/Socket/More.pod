...
It implements C<sockaddr_passive>, which facilitates solutions to
...
implemented such as C<getifaddrs>, C<if_nametoindex>, C<if_indextoname>,
C<if_nameindex>.
...
implemented.  Please see the L<API> section for  a complete listing.
...
B<NOTE> The actually path resulting from the specification will have a '_D' or
